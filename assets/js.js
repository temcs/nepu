...
// ================================
// 7. Missing functions referenced in HTML
// ================================
function fullHeight() {
  var el = document.querySelector('.fullHeight');
  if (el) {
...
function menu_height() {
  // placeholder for menu height adjustment
}
...
// ================================
// 8. Fallback: Convert data-lazy-src images to real src
// ================================
document.addEventListener('DOMContentLoaded', function() {
  // Fix lazy-loaded images that won't load without the WP Rocket lazyload library
  ...
  // Trigger animations - add wpb_start_animation to animated elements
...
document.addEventListener('DOMContentLoaded', function() {
  if (typeof jQuery !== 'undefined' && jQuery.fn.owlCarousel) {
    ...
    jQuery('.hot_carousel').owlCarousel({
      loop: true,
      margin: 15,
      nav: false,
      dots: true,
